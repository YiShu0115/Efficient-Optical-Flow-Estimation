...
class NeuFlow(torch.nn.Module,
    ...
    def forward(self, img0,img1, iters_s16=1, iters_s8=3):
        ...
        for i in range(iters_s16):
            ...
            iter_flow =  torch.cat([feature0_s16,warp_0, context_s16, iter_context_s16, flow0], dim=1)
        ...
        for i in range(iters_s8):
            ...
            iter_flow =  torch.cat([feature0_s8,warp_0, context_s8, iter_context_s8, flow0], dim=1)
