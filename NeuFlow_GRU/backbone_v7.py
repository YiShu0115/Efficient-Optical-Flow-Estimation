...
class CNNEncoder(torch.nn.Module):
    def __init__(self, feature_dim_s16, context_dim_s16, feature_dim_s8, context_dim_s8):
        ...
        self.block_16_1_1 = ConvBlock(3, feature_dim_s16 + context_dim_s16 - 2, kernel_size=6, stride=2, padding=2)
    ...
    def forward(self, img):
        ...
        x_16 = self.block_16_1_1(img)#1/16 scale

        # x_16_2 = self.block_8_16(x_8)#1/16 scale

        # x_16 = self.block_cat_16(torch.cat([x_16, x_16_2], dim=1))#1/16 scale        x_16 = torch.cat([x_16, self.pos_s16], dim=1)
