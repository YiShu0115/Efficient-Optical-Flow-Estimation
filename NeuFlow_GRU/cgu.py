import torch
from NeuFlow_GRU.utils import get_activation
...
class ActGLU(nn.Module):
    def __init__(
        ...
        self.fc1_g =torch.nn.Conv2d(
            in_features,
            hidden_features,
            mlp_in_kernel_size,
            padding=mlp_in_kernel_size // 2,
        )
        self.fc1_x = torch.nn.Conv2d(
            in_features,
            hidden_features,
            mlp_in_kernel_size,
            padding=mlp_in_kernel_size // 2,
...
class CrossActGLU(nn.Module):
    def __init__(
        ...
        self.merge_fc_g = torch.nn.Conv2d(2 * in_features, in_features, 1)
